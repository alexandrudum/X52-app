...
import { Card, Elevation, Button, Tag, Intent, HTMLTable, ProgressBar, Callout } from "@blueprintjs/core";
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      ...
      >
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "14px", marginBottom: "16px" }}>
          <div style={{ padding: "14px", border: "1px solid var(--x52-border-subtle)", borderRadius: "6px" }}>
            <div style={{ fontSize: "11px", color: "var(--x52-text-muted)", textTransform: "uppercase" }}>Monthly Compute Budget</div>
            <div style={{ fontSize: "22px", fontWeight: 800, marginTop: "4px", fontFamily: "var(--x52-font-mono)" }}>
          ...
          <div style={{ padding: "14px", border: "1px solid var(--x52-border-subtle)", borderRadius: "6px" }}>
            ...
            <Tag minimal intent={Intent.SUCCESS} style={{ marginTop: "6px" }}>0 DEGRADED</Tag>
          </div>
        </div>
      </Card>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
          <div>
            <h4 style={{ margin: "0 0 4px 0", fontSize: "14px", fontWeight: 700, display: "flex", alignItems: "center", gap: "8px" }}>
              Upgrade Assistant (Palantir Apollo)
              <Tag minimal intent={Intent.SUCCESS}>Continuous Deployment</Tag>
            </h4>
            <span style={{ fontSize: "12px", color: "var(--x52-text-muted)" }}>
              Evaluates platform updates, tracks upcoming feature rollouts, and ensures zero-downtime system compatibility.
            </span>
          </div>
        </div>
